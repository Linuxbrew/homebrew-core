class SgmlCommon < Formula
  ...
  resource "html-dcl" do
    url "http://stash.tfm.ro/projects/TSERV/repos/server/raw/sgml-common/html.dcl"
    sha256 "61380e02a426f5f48b24f05a1b3bf446c882a13ff4e83706661ab5a0e14bbb49"
  end

  resource "html-soc" do
    url "http://stash.tfm.ro/projects/TSERV/repos/server/raw/sgml-common/html.soc"
    sha256 "f564e94f8d99948f1f1a56768ca68afe6198c0af31ea9a5cdac2b11fe78ccaf0"
  end

  resource "xml-dcl" do
    url "http://stash.tfm.ro/projects/TSERV/repos/server/raw/sgml-common/xml.dcl"
    sha256 "1068e172c737baefc5217b20631771ef83e4c5dd704f3f560a9f16c04f247d16"
  end

  resource "xml-soc" do
    url "http://stash.tfm.ro/projects/TSERV/repos/server/raw/sgml-common/xml.soc"
  ...
  test do
    assert File.exist? "#{prefix}/etc/sgml/sgml.conf"
  end
end
