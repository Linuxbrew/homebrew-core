...
class LlvmAT4 < Formula
  ...
  resource "clang" do
    ...
    patch do
      url "https://github.com/xu-cheng/clang/commit/2813f6d3c65d2b45a32ff9e124f9e40a0f9363cd.patch?full_index=1"
      sha256 "5f7d15a16cc7100ea954a00f62965c3cc4e4f973c4e16421fc76b6f0497384af"
    end unless OS.mac?
  end
